  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        className={cn(
          'mx-auto flex w-fit gap-8 rounded-2xl bg-white px-6 border border-slate-200 rounded-full',
          className
        )}
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn(
            'absolute -top-6 left-1/2 w-fit border border-gray-200 bg-slate-50 px-2 py-0.5 text-base text-slate-700 rounded',
            className
          )}
          role='tooltip'
          style={{ x: '-50%' }}>
