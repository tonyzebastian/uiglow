    ...
    return (
        <div className="circle-container">
            ...
            <div className="circle-wrapper circle1">
                <svg viewBox="0 0 600 600" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision">
                <defs>
                    <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="rgb(45 212 191)" stopOpacity="1" /> {/* teal-400 */}
                        <stop offset="100%" stopColor="rgb(17 94 89)" stopOpacity="0.4" /> {/* teal-900 */}
                    </linearGradient>
                </defs>
                <circle cx="300" cy="300" r="250" fill="none" stroke="url(#grad1)" strokeWidth="0.75"
                        strokeDasharray="520 1050" stroke-dashoffset="20">
            ...
            <div className="circle-wrapper circle2">
                <svg viewBox="0 0 800 800" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision">
                <defs>
                    <linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="rgb(251 146 60)" stopOpacity="0.05" /> {/* orange-400 */}
                        <stop offset="100%" stopColor="rgb(249 115 22)" stopOpacity="1" /> {/* orange-500 */}
                    </linearGradient>
                </defs>
                <circle cx="400" cy="400" r="300" fill="none" stroke="url(#grad2)" strokeWidth="0.75"
                        strokeDasharray="900 985" stroke-dashoffset="0">
            ...
            <div className="circle-wrapper circle3">
                ...
                <circle cx="300" cy="300" r="150" fill="none" stroke="url(#grad3)" strokeWidth="0.75"
                        strokeDasharray="400 542" stroke-dashoffset="60">
            ...
            <div className="circle-wrapper circle4">
                ...
                <defs>
                    <linearGradient id="grad4" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="rgb(252 211 77)" stopOpacity="0.05" /> {/* amber-300 */}
                        <stop offset="100%" stopColor="rgb(251 191 36)" stopOpacity="1" /> {/* amber-400 */}
                    </linearGradient>
                </defs>
                <circle cx="400" cy="400" r="200" fill="none" stroke="url(#grad4)" strokeWidth="0.75"
                        strokeDasharray="500 756" stroke-dashoffset="300">
